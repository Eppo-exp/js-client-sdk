...
|  [configurationStorage?](./js-client-sdk.iclientconfig.configurationstorage.md) |  | IConfigurationStore | _(Optional)_ Custom storage for configuration entries. If not provided, the default storage will be used. |
